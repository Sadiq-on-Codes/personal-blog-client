<template>
    <div :class="{'h-8 w-16': reduceSize}"
      class="flex items-center justify-around w-28 h-12 rounded-full cursor-pointer dark:bg-[--color-background] bg-[--color-background-dark]"
    >
      <SunIcon
        v-if="isDarkMode"
